...
class Wizard extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      finishButton: true, //this.props.steps.length === 1 ? true : false,
      width: width,
      movingTabStyle: {
    ...
    if (this.props.steps) {
      ...
      if (validationState) {
        this.setState({
          ...
          finishButton: true //this.props.steps.length === key + 1 ? true : false
        });
      ...
      this.setState(
        ...
        () => {
          ...
          for (var i = 0; i < this.props.steps.length; i++) {
            if (this[this.props.steps[i].stepId].sendState !== undefined) {
              let stateCollected = this[this.props.steps[i].stepId].sendState();
              finalState[this.props.steps[i].stepId] = stateCollected;

            }
          }
          this.props.finishButtonClick(finalState);
          this.setState({ allStates: finalState });
          ...
          <div className={classes.wizardNavigation}>
            <ul className={classes.nav}>
              {steps.map((prop, key) => {
                ...
                return (prop.stepName === steps[this.state.currentStep].stepName )? ( <li
                ...
                >
                  <a
                    href="#pablo"
                    className={classes.stepsAnchorActive}
                    onClick={e => {
                      e.preventDefault();
              ...
              return (
                <div className={stepContentClasses} key={key}>
                  <prop.stepComponent
                    ...
                    globalEditData={prop.globalEditData}
                    allDataWizardSaveState={prop.allDataWizardSaveState}
                  />
                </div>
              );
            })}
          ...
          <div className={classes.footer}>
            ...
            <div className={classes.right}>
              ...
              {this.state.finishButton ? (
                ((this.props.finishButtonEnabled !== undefined && this.props.finishButtonEnabled === true) ?
                  (<Button
                    color="rose"
...
Wizard.propTypes = {
  ...
  finishButtonEnabled: PropTypes.bool,
