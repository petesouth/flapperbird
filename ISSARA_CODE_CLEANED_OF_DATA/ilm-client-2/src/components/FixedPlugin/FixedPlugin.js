...
export default function FixedPlugin(props) {
  ...
  const preferencesMenuShowImage = localStorage.getItem('preferencesMenuShowImage')? JSON.parse(localStorage.getItem('preferencesMenuShowImage')) : true

  const [classes, setClasses] = React.useState("dropdown show");
  const [bg_checked, setBg_checked] = React.useState(true);
  const [bgImage, setBgImage] = React.useState(props.bgImage);
  const [showImage, setShowImage] = React.useState(preferencesMenuShowImage);
  const handleClick = () => {
  ...
  const handleChange = name => event => {
    switch (name) {
      ...
      case "image":
        ...
        localStorage.setItem('preferencesMenuShowImage', event.target.checked)
            ...
            <a className="switch-trigger active-color">
              <div className="badge-colors text-center">
                ...
                <span
                  className={
                    props.color === "teal"
                      ? "badge filter badge-teal active"
                      : "badge filter badge-teal"
                  }
                  data-color="teal"
                  onClick={() => {
                    props.handleColorClick("teal");
                  }}
                />
                <span
                  className={
...
FixedPlugin.propTypes = {
  ...
  bgColor: PropTypes.oneOf(["white", "black", "blue", "teal"]),
