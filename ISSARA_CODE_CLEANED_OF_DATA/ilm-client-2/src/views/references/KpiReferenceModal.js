        ...
        <div className={classes.paper}>
          ...
          {kpi &&
            <div>
              ...
              <Divider />
              <h5> Other: </h5>
              <p> <span className={classes.spanLabel}> Legal Violation: </span>  {kpi.kpi_legal_violation && kpi.kpi_legal_violation.description || '-'} </p>
              <p> <span className={classes.spanLabel}> Recommended Remediation: </span>  {kpi.kpi_recommended_remediation && kpi.kpi_recommended_remediation.description || '-'} </p>
              <p> <span className={classes.spanLabel}> Systems Change: </span> {kpi.kpi_systems_change && kpi.kpi_systems_change.description || '-'}</p>
            </div>
          }
        </div>
      </Modal>
